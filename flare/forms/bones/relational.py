...
class RelationalEditWidget( BaseEditWidget ):
	...
	def onSelectBtnClick( self ):
		...
		print(selector)
		print(self.bone)
		print(self.bone.destModule)
		print( self.bone.destInfo)
		print(moduleWidgetSelector._q)
		...
		self.fromHTML(
			"""
				<div class="flr-bone-widgets">
					...
					<div class="flr-widgets-item">
						<div [name]="dropArea" style="background-color: white; outline: 2px dashed black; outline-offset: -10px; height: 100px;">
						{0}
							<label for="inplace-upload" style="text-align: center; vertical-align: middle;"><strong>Datei auswählen</strong><span [name]="dropText"> oder hierhin ziehen</span>.</label>
							<input id="inplace-upload" class="box__file" type="file" [name]="files" files selected"/>
						</div>
